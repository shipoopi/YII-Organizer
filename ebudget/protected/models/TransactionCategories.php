 ...
 *
 * The followings are the available columns in table 'transaction_categories':
 * @property string $id
 * @property string $created
 * @property string $modified
 * @property string $name
 * @property string $transaction_count
 */
class TransactionCategories extends CActiveRecord
{
	 ...
	 * @return TransactionCategories the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, created, modified, name, transaction_count', 'safe', 'on'=>'search'),
		);
	}
